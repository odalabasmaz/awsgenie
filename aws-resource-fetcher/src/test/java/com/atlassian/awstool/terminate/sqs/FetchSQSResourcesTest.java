...
public class FetchSQSResourcesTest {
    ...
    private FetchSQSResources fetchSQSResources;
    ...
    public void setUp() throws Exception {
        ...
        this.fetchSQSResources = new FetchSQSResources(fetcherConfiguration);
    ...
    public void listResources() {
        ...
        fetchSQSResources.listResources(TEST_REGION, actualQueues::addAll);
    ...
    public void fetchResources() {
        ...
        List<SQSResource> actualResources = fetchSQSResources.fetchResources(TEST_REGION, resources, details);
