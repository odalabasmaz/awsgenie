...
public class FetchIAMPolicyResourcesTest {
    ...
    private FetchIAMPolicyResources fetchIAMPolicyResources;
    ...
    public void setUp() throws Exception {
        ...
        this.fetchIAMPolicyResources = new FetchIAMPolicyResources(fetcherConfiguration);
    }
    ...
    public void listResources() {
        ...
        fetchIAMPolicyResources.listResources(TEST_REGION, actualPolicies::addAll);
    ...
    public void fetchResources() {
        ...
        List<IAMPolicyResource> actualResources = fetchIAMPolicyResources.fetchResources(TEST_REGION, resources, details);
