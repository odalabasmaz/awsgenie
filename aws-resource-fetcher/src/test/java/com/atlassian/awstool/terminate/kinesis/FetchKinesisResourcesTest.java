...
public class FetchKinesisResourcesTest {
    ...
    private FetchKinesisResources fetchKinesisResources;
    ...
    public void setUp() throws Exception {
        ...
        this.fetchKinesisResources = new FetchKinesisResources(fetcherConfiguration);
    }
    ...
    public void listResources() {
        ...
        fetchKinesisResources.listResources(TEST_REGION, actualStreams::addAll);
    ...
    public void fetchResources() {
        ...
        List<KinesisResource> actualResources = fetchKinesisResources.fetchResources(TEST_REGION, resources, details);
    ...
    public void getUsage() throws Exception {
        ...
        Object usage = fetchKinesisResources.getUsage(TEST_REGION, "stream1", 7);
