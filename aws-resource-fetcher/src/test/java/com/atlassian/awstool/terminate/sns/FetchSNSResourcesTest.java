...
public class FetchSNSResourcesTest {
    ...
    private FetchSNSResources fetchSNSResources;
    ...
    public void setUp() throws Exception {
        ...
        this.fetchSNSResources = new FetchSNSResources(fetcherConfiguration);
    ...
    public void listResources() {
        ...
        fetchSNSResources.listResources(TEST_REGION, actualTopics::addAll);
    ...
    public void fetchResources() {
        ...
        List<SNSResource> actualResources = fetchSNSResources.fetchResources(TEST_REGION, resources, details);
